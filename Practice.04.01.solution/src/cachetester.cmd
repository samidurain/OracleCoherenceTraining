...
set java_opts="-Xms%memory% -Xmx%memory% -Dtangosol.coherence.ttl=0 -Dtangosol.coherence.cacheconfig=C:\Oracle\student\practices\Practice.04.01.solution\config\coherence-cache-config.xml"
